...
import { BarcodeScanner, SupportedFormat,BarcodeScannerPlugin } from '@capacitor-community/barcode-scanner';
 ...
 ngOnInit(){
  ...
  extractColDocumentData(data) {
    ...
    if (HAS_UPPERCASE.test(info[3])) {
      ...
      this.numIdentificacion = idString.substring(10, idString.length);
